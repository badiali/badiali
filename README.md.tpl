...
<p align="center">
  <img src="https://konpa.github.io/devicon/devicon.git/icons/html5/html5-original.svg" alt="html5" width="%{{icon_size_x2}}%" height="%{{icon_size_x2}}%"/>
  <img src="https://konpa.github.io/devicon/devicon.git/icons/css3/css3-original.svg" alt="css" width="%{{icon_size_x2}}%" height="%{{icon_size_x2}}%"/>
  <img src="https://konpa.github.io/devicon/devicon.git/icons/sass/sass-original.svg" alt="sass" width="%{{icon_size_x2}}%" height="%{{icon_size_x2}}%"/>
  <img src="https://konpa.github.io/devicon/devicon.git/icons/javascript/javascript-original.svg" alt="javascript" width="%{{icon_size_x2}}%" height="%{{icon_size_x2}}%"/>
  <img src="https://konpa.github.io/devicon/devicon.git/icons/bootstrap/bootstrap-plain.svg" alt="bootstrap" width="%{{icon_size_x2}}%" height="%{{icon_size_x2}}%"/>
  <img src="https://konpa.github.io/devicon/devicon.git/icons/wordpress/wordpress-original.svg" alt="wordpress" width="%{{icon_size_x2}}%" height="%{{icon_size_x2}}%"/>
  <img src="https://konpa.github.io/devicon/devicon.git/icons/gulp/gulp-plain.svg" alt="gulp" width="%{{icon_size_x2}}%" height="%{{icon_size_x2}}%"/>
  <img src="https://konpa.github.io/devicon/devicon.git/icons/nodejs/nodejs-original.svg" alt="nodejs" width="%{{icon_size_x2}}%" height="%{{icon_size_x2}}%"/>
</p>
